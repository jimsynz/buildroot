...
ifeq ($(BR2_PACKAGE_HOST_ANDROID_TOOLS_MKBOOTIMG),y)
HOST_ANDROID_TOOLS_BUILD_TARGETS += mkbootimg
HOST_ANDROID_TOOLS_INSTALL_TARGETS += build-mkbootimg/mkbootimg

define HOST_ANDROID_TOOLS_INSTALL_MKBOOTIMG_FILES
	cp $(ANDROID_TOOLS_PKGDIR)/mkbootimg.mk $(@D)/debian/makefiles/
	cp $(ANDROID_TOOLS_PKGDIR)/sha_wrapper.c $(@D)/debian/makefiles/
endef

HOST_ANDROID_TOOLS_POST_PATCH_HOOKS += HOST_ANDROID_TOOLS_INSTALL_MKBOOTIMG_FILES
endif
